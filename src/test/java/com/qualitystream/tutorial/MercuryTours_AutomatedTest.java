...
public class MercuryTours_AutomatedTest {
	...
	public void registerUser() throws InterruptedException {
		...
		{
			driver.findElement(usernameLocator).sendKeys("spidfer123");
			...
			System.out.print("Register pages was no found");
		
		List<WebElement> fonts = driver.findElements(By.tagName("font"));
		assertEquals("Note: Your user name is spidfer123.",fonts.get(5).getText());
	}
	...
	public void signIn() throws InterruptedException
	{
		...
		{
			driver.findElement(userLocator).sendKeys("spidfer123");
			driver.findElement(passLocator).sendKeys("pass1");
			driver.findElement(signInBtnLocator).click();
			Thread.sleep(2000);
			assertEquals("Login Successfully",driver.findElement(By.tagName("h3")).getText());
		}
	}
